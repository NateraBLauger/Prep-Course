...
function mayuscula(nombre) {
  ...
  var pl = nombre[0].toUpperCase();
  var rl = nombre.slice(1);
  var nuevoNombre = pl + rl ;
  return nuevoNombre;
}
...
function operacionMatematica(n1, n2, cb) {
  ...
  // junto con dos números. Devolver el callback pasándole como argumentos los números
  // recibidos. Tu código:
   return cb(n1, n2);
}
...
function map(array, cb) {
  ...
  // por `cb` en un nuevo array. El nuevo array debe tener la misma longitud que el array 
  //del argumento. Tu código:
...
function filter(array) {
  ...
  var nArray = array.filter(comienzaConA);
  return nArray;
}
